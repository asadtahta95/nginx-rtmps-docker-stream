...
LABEL maintainer="As'ad Tahta Alfina <asadtahta950@gmail.com>"
...
COPY stunnel/local.conf /etc/stunnel/conf.d/local.conf
...
#Instagram
ENV LOCAL_URL rtmp://127.0.0.1:19351/rtmp/
ENV LOCAL_KEY ""
